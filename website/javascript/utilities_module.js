window.utilities_module = function(){ 
    ...
    var getInfoFromUrl = function(){
        ...
        try{
            if ( true ){
                this.infoFromUrl = JSON.parse(JSON.stringify({"mr":[{"a":"31051900100900","x":1304348.4470424068,"y":425941.399917507,"m":" There is an opening in the\nfence at this corner that is\nbig enough for people to \nwalk. Is this spot where he\ndrives a tractor onto the \nfield? Could the inmates be\ndropped off here and the van \npark in David Gladstones \ndriveway?","i":"http://i8.photobucket.com/albums/a30/echandler/looking_north_west.jpg"},{"a":"","x":1303044.2803757333,"y":425900.5665841737,"m":" The grey van parks here\nusually, last fall they parked\nit in the street for no reason, \nat least one day maybe more.","i":""},{"a":"","x":1303090.11370902,"y":426005.9832508373,"m":" I sleep and work in the travel \ntrailer because it is more quite \nand comfortable than inside the\nhouse. I make software like this\nmap.","i":""},{"a":"31051900201400","x":1303006.010233489,"y":426341.3574609451,"m":" There is a spot here where\nthey could park. This is where\nhis workers used to park when\nthey started planting trees in\nthe field. This corner was big\nenough for multiple vehicles\nto park with enough room for\nothers to pass by.","i":""},{"a":"","x":1303041.9182238667,"y":426178.5313668077,"m":" They have parked and\nunloaded workers here\nin the past. It isn't great\nbut the van could park \ndown his driveway?","i":""},{"a":"31051900100900","x":1303111.50155709,"y":425950.1980334633,"m":" They walk about 30-50ft from the travel \ntrailer the walls are very thin, they are \nvery annoying and disrespectful. If they \njust minded their own business and didn't \nraise their voices or act angry and crazy \nand were respectful all would be well.","i":""}],"l":[["1304305,425968","1304415,425968","1304415,425878","1304300,425881","1304305,425968"],["1303032,425889","1303096,425907","1303117,425957","1303139,425972","1303157,425962"],["1303005,426196","1303008,426337","1302997,426343","1302933,426345","1302933,426345"]],"x":1302293.37655704,"mx":1305093.37655704,"my":427012.28136679,"z":60,"y":425467.28136679}));
    ...
    var makeArcXMLRequest = function ( minX, maxX, minY, maxY, arg_onPopState, arg_overLayMap ){
        ...
        var height = this.resizedMapHeight,
            ...
            roadWidth = ~~(( sliderPositionNumber + 2 ) * 4 * (( width * height ) / (( maxX - minX ) * ( maxY - minY ))) + 2),
