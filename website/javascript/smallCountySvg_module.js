...
var mouseUp = function(e){
  ...
  var smallCountySvgReCalc = function(){
    ...
    if( this.theMap.optionsReference.showSatelliteView_CheckMark ){
      ...
      this.box.parentNode.querySelector('g').style.fill = 'white';
      if( !this.box.parentNode.mouseIsOver ){
        this.box.parentNode.querySelector('g').style.fillOpacity = '0.5';
      }
    } else {
      this.box.style.fill = '';
...
//     window.$('test_rect').setAttribute('height', this.box.data.height);
  ...
  var private_smallCountySvgCalculateStartPosition = function( arg_spX, arg_spY, arg_offsetWidth, arg_offsetHeight ){
      ...
      return {
          ...
          smallCountySvgInit: smallCountySvgInit,
