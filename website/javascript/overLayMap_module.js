var overlayMap_module = function(){
        ...
        function private_makeOverlayMap(){
            ...
            private_overlayMapContainer.style.top = theMap.topp + 'px';
            private_overlayMapContainer.style.left= theMap.left + 'px';
            private_overlayMapContainer.style.width = window.theMap.resizedMapWidth +'px';
            private_overlayMapContainer.style.height =  window.theMap.resizedMapWidth +'px';
            ...
            //document.getElementById('think_of_a_name_for_this').apend//appendChild( private_overlayMapContainer );
            window.$('think_of_a_name_for_this').insertBefore( private_overlayMapContainer, window.$('theMap_misc_container').nextElementSibling );
            ...
            var overLayMap_mouseMove = function( e ){
                this.rightDragDiv.style.top   = e.clientY - 30 - this.theMap.containerStyleTop +'px';
                this.leftDragDiv.style.top    = e.clientY - 30 - this.theMap.containerStyleTop +'px';
                this.topDragDiv.style.left    = e.clientX - 30 - this.theMap.containerStyleLeft +'px';
                this.bottomDragDiv.style.left = e.clientX - 30 - this.theMap.containerStyleLeft +'px';
